...
const filterGroups = [
  {
    ...
    options: [
      ...
      { label: "Southeast Asia", checked: true },
      { label: "Latin America" },
  ...
  },
  {
    title: "Status",
    options: [
      { label: "Active", checked: true, indicator: "bg-primary" },
      { label: "Planning", indicator: "bg-eco-ochre" },
      { label: "Halted", indicator: "bg-eco-clay" },
    ],
  },
  {
...
export default function ProjectHubPage() {
  return (
    <>
          ...
          <div className="p-8 relative z-10 max-w-[1920px] mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-end gap-4">
                <h2 className="text-3xl font-display font-bold text-foreground leading-none">Projects</h2>
                <span className="text-sm font-mono text-muted-foreground mb-1 uppercase">Showing 14 of 42</span>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button className="h-10 px-6 bg-primary text-white font-mono text-xs uppercase font-bold hover:bg-eco-primary-dark transition-colors flex items-center gap-2">
      ...
      {/* Bottom accent line */}
      <div className="h-1 w-full bg-primary flex-none" />
    </>
  );
}
